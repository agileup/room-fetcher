...
const MAX_DEPOSIT = 23000
const MAX_RENT = 30

const lat_north = 37.51062932943603
const lng_west = 127.10044670890565
const lat_south = 37.50038866590318
const lng_east = 127.11448552527204
...
app.get('/zigbang', function(req, res) {
    async.auto({
        ids: (cb) => {
            const zIdsUrl = `https://api.zigbang.com/v3/items2?lat_south=${lat_south}&lat_north=${lat_north}&lng_west=${lng_west}&lng_east=${lng_east}&room=[04,05]&deposit_e=${MAX_DEPOSIT}&rent_e=${MAX_RENT}`
